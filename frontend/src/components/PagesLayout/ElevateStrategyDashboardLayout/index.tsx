...
export interface ElevateStrategyDashboardLayoutProps {
...
const ContentWrapper = styled(Box)(({ theme }) => ({
  width: 'calc(100% - 180px)', // Adjust for sidebar width
  height: '100%',
  display: 'flex',
  flexDirection: 'column',
  padding: theme.spacing(3),
  marginLeft: '210px', // Match sidebar width
  overflow: 'hidden',
...
const ElevateStrategyDashboardLayout: React.FC<ElevateStrategyDashboardLayoutProps> = ({ children, pageTitle }) => {
    ...
    // Navigation items for the sidebar - only two main items
    const navItems: NavItem[] = [
        {
          text: 'Revenue Target',
          icon: <TrendingUpIcon />,
          path: '/elevate-strategy/revenue-strategy',
        },
        { type: 'divider' },
        {
          text: 'Vendor Payment',
          icon: <AccountBalanceWalletIcon />,
          path: '/elevate-strategy/vendor-payment-strategy',
        },
        { type: 'divider' }
    ];

  return (
    <PageContainer className="elevate-strategy-dashboard-container">
      {/* Custom Header */}
      ...
      <MainContent sx={{
        ...
        {/* Content Wrapper */}
        <ContentWrapper className="elevate-strategy-dashboard-content-wrapper">
          ...
          >
            ...
            <Grid item xs={12} sm={4}>
              <FeatureButton 
                ...
                onClick={() => handleNavigation('/evaluate-performance/financial-overview')}
              >
                <Typography variant="h6" component="span" sx={{ fontWeight: 600 }}>
...
export default ElevateStrategyDashboardLayout; 