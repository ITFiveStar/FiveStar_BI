...
const BrandCOGSPieChart: React.FC<{ displayMode?: string; dateUpTo?: Date | null }> = ({
  displayMode = 'month',
  dateUpTo
}) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const res = await axios.get(`/cogs_details/COGS_pie_chart_data_brand_in_PC?${params.toString()}`);
        setData(res.data.pie_by_brand);
...
export default BrandCOGSPieChart;
